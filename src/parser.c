...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_value] = STATE(19),
    [sym_builtin_function_call] = STATE(17),
    [sym_setting] = STATE(18),
    [sym_backtick] = STATE(17),
    [sym_indented_backtick] = STATE(17),
    [sym_string] = STATE(17),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 1, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 1, 0, 0),
