...
enum ts_symbol_identifiers {
  ...
  anon_sym_COMMA = 69,
  anon_sym_set = 70,
  anon_sym_allow_DASHduplicate_DASHrecipes = 71,
  anon_sym_allow_DASHduplicate_DASHvariables = 72,
  anon_sym_dotenv_DASHfilename = 73,
  anon_sym_dotenv_DASHload = 74,
  anon_sym_dotenv_DASHpath = 75,
  anon_sym_dotenv_DASHrequired = 76,
  anon_sym_export = 77,
  anon_sym_fallback = 78,
  anon_sym_ignore_DASHcomments = 79,
  anon_sym_positional_DASHarguments = 80,
  anon_sym_tempdir = 81,
  anon_sym_unstable = 82,
  anon_sym_windows_DASHpowershell = 83,
  anon_sym_windows_DASHshell = 84,
  anon_sym_LBRACK = 85,
  anon_sym_RBRACK = 86,
  anon_sym_BQUOTE = 87,
  aux_sym_backtick_token1 = 88,
  anon_sym_BQUOTE_BQUOTE_BQUOTE = 89,
  aux_sym_indented_backtick_token1 = 90,
  anon_sym_DQUOTE_DQUOTE_DQUOTE = 91,
  aux_sym_indented_normal_string_token1 = 92,
  anon_sym_DQUOTE = 93,
  aux_sym_normal_string_token1 = 94,
  anon_sym_SQUOTE_SQUOTE_SQUOTE = 95,
  aux_sym_indented_raw_string_token1 = 96,
  anon_sym_SQUOTE = 97,
  aux_sym_raw_string_token1 = 98,
  anon_sym_BSLASHn = 99,
  anon_sym_BSLASHr = 100,
  anon_sym_BSLASHt = 101,
  anon_sym_BSLASH_DQUOTE = 102,
  ...
  sym_setting = 121,
  sym__setting_boolean = 122,
  sym__setting_string = 123,
  sym__setting_list = 124,
  sym_backtick = 125,
  sym_indented_backtick = 126,
  sym_string = 127,
  sym_indented_normal_string = 128,
  sym_normal_string = 129,
  sym_indented_raw_string = 130,
  sym_raw_string = 131,
  ...
  aux_sym__setting_list_repeat1 = 137,
  aux_sym_indented_backtick_repeat1 = 138,
  aux_sym_indented_normal_string_repeat1 = 139,
  aux_sym_normal_string_repeat1 = 140,
  aux_sym_indented_raw_string_repeat1 = 141,
};
