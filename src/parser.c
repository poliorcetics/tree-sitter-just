...
enum ts_symbol_identifiers {
  ...
  sym_function_parameters = 149,
  sym_setting = 150,
  sym__setting_boolean = 151,
  sym__setting_string = 152,
  sym__setting_list = 153,
  sym_backtick = 154,
  sym_indented_backtick = 155,
  sym_string = 156,
  sym_indented_normal_string = 157,
  sym_normal_string = 158,
  sym_indented_raw_string = 159,
  sym_raw_string = 160,
  sym_escape_sequence = 161,
  sym_boolean = 162,
  sym_comment = 163,
  aux_sym_file_repeat1 = 164,
  aux_sym_function_parameters_repeat1 = 165,
  aux_sym__setting_list_repeat1 = 166,
  aux_sym_indented_backtick_repeat1 = 167,
  aux_sym_indented_normal_string_repeat1 = 168,
  aux_sym_normal_string_repeat1 = 169,
  aux_sym_indented_raw_string_repeat1 = 170,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_string] = STATE(26),
    [sym_indented_normal_string] = STATE(4),
    [sym_normal_string] = STATE(4),
    [sym_indented_raw_string] = STATE(4),
  ...
  [12] = {
    ...
    [anon_sym_datetime_utc] = ACTIONS(145),
    [anon_sym_semver_matches] = ACTIONS(145),
  ...
  [13] = {
    ...
    [anon_sym_datetime_utc] = ACTIONS(149),
    [anon_sym_semver_matches] = ACTIONS(149),
    [anon_sym_cache_dir] = ACTIONS(149),
    [anon_sym_cache_directory] = ACTIONS(149),
    [anon_sym_config_dir] = ACTIONS(149),
    [anon_sym_config_directory] = ACTIONS(149),
    [anon_sym_config_local_dir] = ACTIONS(149),
    [anon_sym_config_local_directory] = ACTIONS(149),
    [anon_sym_data_dir] = ACTIONS(149),
    [anon_sym_data_directory] = ACTIONS(149),
    [anon_sym_data_local_dir] = ACTIONS(149),
    [anon_sym_data_local_directory] = ACTIONS(149),
    [anon_sym_executable_dir] = ACTIONS(149),
    [anon_sym_executable_directory] = ACTIONS(149),
    [anon_sym_home_dir] = ACTIONS(149),
    [anon_sym_home_directory] = ACTIONS(149),
  ...
  [39] = {
    ...
    [aux_sym_mod_token1] = ACTIONS(227),
  ...
  [56] = {
    [sym__setting_boolean] = STATE(60),
    [sym__setting_string] = STATE(60),
    [sym__setting_list] = STATE(60),
  ...
  [69] = {
    ...
    [aux_sym_import_token1] = ACTIONS(293),
    [aux_sym_mod_token1] = ACTIONS(293),
    [anon_sym_if] = ACTIONS(293),
    [anon_sym_assert] = ACTIONS(293),
    [anon_sym_LPAREN] = ACTIONS(291),
    [anon_sym_arch] = ACTIONS(293),
    [anon_sym_num_cpus] = ACTIONS(293),
    [anon_sym_os] = ACTIONS(293),
    [anon_sym_os_family] = ACTIONS(293),
    [anon_sym_shell] = ACTIONS(293),
    [anon_sym_env_var] = ACTIONS(293),
    [anon_sym_env_var_or_default] = ACTIONS(293),
    [anon_sym_env] = ACTIONS(293),
    [anon_sym_is_dependency] = ACTIONS(293),
    [anon_sym_invocation_dir] = ACTIONS(293),
    [anon_sym_invocation_dir_native] = ACTIONS(293),
    [anon_sym_invocation_directory] = ACTIONS(293),
    [anon_sym_invocation_directory_native] = ACTIONS(293),
    [anon_sym_justfile] = ACTIONS(293),
    [anon_sym_justfile_dir] = ACTIONS(293),
    [anon_sym_justfile_directory] = ACTIONS(293),
    [anon_sym_source_dir] = ACTIONS(293),
    [anon_sym_source_directory] = ACTIONS(293),
    [anon_sym_source_file] = ACTIONS(293),
    [anon_sym_just_executable] = ACTIONS(293),
    [anon_sym_just_pid] = ACTIONS(293),
    [anon_sym_append] = ACTIONS(293),
    [anon_sym_prepend] = ACTIONS(293),
    [anon_sym_encode_uri_component] = ACTIONS(293),
    [anon_sym_quote] = ACTIONS(293),
    [anon_sym_replace] = ACTIONS(293),
    [anon_sym_replace_regex] = ACTIONS(293),
    [anon_sym_trim] = ACTIONS(293),
    [anon_sym_trim_end] = ACTIONS(293),
    [anon_sym_trim_end_match] = ACTIONS(293),
    [anon_sym_trim_end_matches] = ACTIONS(293),
    [anon_sym_trim_start] = ACTIONS(293),
    [anon_sym_trim_start_match] = ACTIONS(293),
    [anon_sym_trim_start_matches] = ACTIONS(293),
    [anon_sym_capitalize] = ACTIONS(293),
    [anon_sym_kebabcase] = ACTIONS(293),
    [anon_sym_lowercamelcase] = ACTIONS(293),
    [anon_sym_lowercase] = ACTIONS(293),
    [anon_sym_shoutykebabcase] = ACTIONS(293),
    [anon_sym_shoutysnakecase] = ACTIONS(293),
    [anon_sym_snakecase] = ACTIONS(293),
    [anon_sym_titlecase] = ACTIONS(293),
    [anon_sym_uppercamelcase] = ACTIONS(293),
    [anon_sym_uppercase] = ACTIONS(293),
    [anon_sym_absolute_path] = ACTIONS(293),
    [anon_sym_canonicalize] = ACTIONS(293),
    [anon_sym_extension] = ACTIONS(293),
    [anon_sym_file_name] = ACTIONS(293),
    [anon_sym_file_stem] = ACTIONS(293),
    [anon_sym_parent_dir] = ACTIONS(293),
    [anon_sym_parent_directory] = ACTIONS(293),
    [anon_sym_without_extension] = ACTIONS(293),
    [anon_sym_clean] = ACTIONS(293),
    [anon_sym_join] = ACTIONS(293),
    [anon_sym_path_exists] = ACTIONS(293),
    [anon_sym_error] = ACTIONS(293),
    [anon_sym_blake3] = ACTIONS(293),
    [anon_sym_blake3_file] = ACTIONS(293),
    [anon_sym_sha256] = ACTIONS(293),
    [anon_sym_sha256_file] = ACTIONS(293),
    [anon_sym_uuid] = ACTIONS(293),
    [anon_sym_choose] = ACTIONS(293),
    [anon_sym_datetime] = ACTIONS(293),
    [anon_sym_datetime_utc] = ACTIONS(293),
    [anon_sym_semver_matches] = ACTIONS(293),
    [anon_sym_cache_dir] = ACTIONS(293),
    [anon_sym_cache_directory] = ACTIONS(293),
    [anon_sym_config_dir] = ACTIONS(293),
    [anon_sym_config_directory] = ACTIONS(293),
    [anon_sym_config_local_dir] = ACTIONS(293),
    [anon_sym_config_local_directory] = ACTIONS(293),
    [anon_sym_data_dir] = ACTIONS(293),
    [anon_sym_data_directory] = ACTIONS(293),
    [anon_sym_data_local_dir] = ACTIONS(293),
    [anon_sym_data_local_directory] = ACTIONS(293),
    [anon_sym_executable_dir] = ACTIONS(293),
    [anon_sym_executable_directory] = ACTIONS(293),
    [anon_sym_home_dir] = ACTIONS(293),
    [anon_sym_home_directory] = ACTIONS(293),
  ...
  [70] = {
    ...
    [anon_sym_alias] = ACTIONS(297),
    [aux_sym_import_token1] = ACTIONS(297),
    [aux_sym_mod_token1] = ACTIONS(297),
    [anon_sym_if] = ACTIONS(297),
    [anon_sym_assert] = ACTIONS(297),
    [anon_sym_LPAREN] = ACTIONS(295),
    [anon_sym_arch] = ACTIONS(297),
    [anon_sym_num_cpus] = ACTIONS(297),
    [anon_sym_os] = ACTIONS(297),
    [anon_sym_os_family] = ACTIONS(297),
    [anon_sym_shell] = ACTIONS(297),
    [anon_sym_env_var] = ACTIONS(297),
    [anon_sym_env_var_or_default] = ACTIONS(297),
    [anon_sym_env] = ACTIONS(297),
    [anon_sym_is_dependency] = ACTIONS(297),
    [anon_sym_invocation_dir] = ACTIONS(297),
    [anon_sym_invocation_dir_native] = ACTIONS(297),
    [anon_sym_invocation_directory] = ACTIONS(297),
    [anon_sym_invocation_directory_native] = ACTIONS(297),
    [anon_sym_justfile] = ACTIONS(297),
    [anon_sym_justfile_dir] = ACTIONS(297),
    [anon_sym_justfile_directory] = ACTIONS(297),
    [anon_sym_source_dir] = ACTIONS(297),
    [anon_sym_source_directory] = ACTIONS(297),
    [anon_sym_source_file] = ACTIONS(297),
    [anon_sym_just_executable] = ACTIONS(297),
    [anon_sym_just_pid] = ACTIONS(297),
    [anon_sym_append] = ACTIONS(297),
    [anon_sym_prepend] = ACTIONS(297),
    [anon_sym_encode_uri_component] = ACTIONS(297),
    [anon_sym_quote] = ACTIONS(297),
    [anon_sym_replace] = ACTIONS(297),
    [anon_sym_replace_regex] = ACTIONS(297),
    [anon_sym_trim] = ACTIONS(297),
    [anon_sym_trim_end] = ACTIONS(297),
    [anon_sym_trim_end_match] = ACTIONS(297),
    [anon_sym_trim_end_matches] = ACTIONS(297),
    [anon_sym_trim_start] = ACTIONS(297),
    [anon_sym_trim_start_match] = ACTIONS(297),
    [anon_sym_trim_start_matches] = ACTIONS(297),
    [anon_sym_capitalize] = ACTIONS(297),
    [anon_sym_kebabcase] = ACTIONS(297),
    [anon_sym_lowercamelcase] = ACTIONS(297),
    [anon_sym_lowercase] = ACTIONS(297),
    [anon_sym_shoutykebabcase] = ACTIONS(297),
    [anon_sym_shoutysnakecase] = ACTIONS(297),
    [anon_sym_snakecase] = ACTIONS(297),
    [anon_sym_titlecase] = ACTIONS(297),
    [anon_sym_uppercamelcase] = ACTIONS(297),
    [anon_sym_uppercase] = ACTIONS(297),
    [anon_sym_absolute_path] = ACTIONS(297),
    [anon_sym_canonicalize] = ACTIONS(297),
    [anon_sym_extension] = ACTIONS(297),
    [anon_sym_file_name] = ACTIONS(297),
    [anon_sym_file_stem] = ACTIONS(297),
    [anon_sym_parent_dir] = ACTIONS(297),
    [anon_sym_parent_directory] = ACTIONS(297),
    [anon_sym_without_extension] = ACTIONS(297),
    [anon_sym_clean] = ACTIONS(297),
    [anon_sym_join] = ACTIONS(297),
    [anon_sym_path_exists] = ACTIONS(297),
    [anon_sym_error] = ACTIONS(297),
    [anon_sym_blake3] = ACTIONS(297),
    [anon_sym_blake3_file] = ACTIONS(297),
    [anon_sym_sha256] = ACTIONS(297),
    [anon_sym_sha256_file] = ACTIONS(297),
    [anon_sym_uuid] = ACTIONS(297),
    [anon_sym_choose] = ACTIONS(297),
    [anon_sym_datetime] = ACTIONS(297),
    [anon_sym_datetime_utc] = ACTIONS(297),
    [anon_sym_semver_matches] = ACTIONS(297),
    [anon_sym_cache_dir] = ACTIONS(297),
    [anon_sym_cache_directory] = ACTIONS(297),
    [anon_sym_config_dir] = ACTIONS(297),
    [anon_sym_config_directory] = ACTIONS(297),
    [anon_sym_config_local_dir] = ACTIONS(297),
    [anon_sym_config_local_directory] = ACTIONS(297),
    [anon_sym_data_dir] = ACTIONS(297),
    [anon_sym_data_directory] = ACTIONS(297),
    [anon_sym_data_local_dir] = ACTIONS(297),
    [anon_sym_data_local_directory] = ACTIONS(297),
    [anon_sym_executable_dir] = ACTIONS(297),
    [anon_sym_executable_directory] = ACTIONS(297),
    [anon_sym_home_dir] = ACTIONS(297),
    [anon_sym_home_directory] = ACTIONS(297),
    [anon_sym_set] = ACTIONS(297),
    [anon_sym_BQUOTE] = ACTIONS(297),
    [anon_sym_BQUOTE_BQUOTE_BQUOTE] = ACTIONS(295),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(130)] = 980,
  [SMALL_STATE(131)] = 990,
  [SMALL_STATE(132)] = 1000,
  [SMALL_STATE(133)] = 1010,
  [SMALL_STATE(134)] = 1020,
  [SMALL_STATE(135)] = 1030,
  [SMALL_STATE(136)] = 1040,
  [SMALL_STATE(137)] = 1050,
  [SMALL_STATE(138)] = 1060,
  [SMALL_STATE(139)] = 1070,
  [SMALL_STATE(140)] = 1080,
  [SMALL_STATE(141)] = 1090,
  [SMALL_STATE(142)] = 1100,
  [SMALL_STATE(143)] = 1110,
  [SMALL_STATE(144)] = 1120,
  [SMALL_STATE(145)] = 1130,
  [SMALL_STATE(146)] = 1140,
  [SMALL_STATE(147)] = 1150,
  [SMALL_STATE(148)] = 1160,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(138),
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(83),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(147),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [66] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [72] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(115),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(103),
  [81] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(110),
  [84] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(102),
  ...
  [93] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(134),
  [96] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(95),
  [99] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [102] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(94),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
  ...
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indented_normal_string, 2, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indented_normal_string, 2, 0, 0),
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indented_raw_string, 2, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indented_raw_string, 2, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_indented_backtick, 3, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_indented_backtick, 3, 0, 0),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p0, 2, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p0, 2, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 3, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_value, 3, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4, 0, 2),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4, 0, 2),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, 0, 2),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3, 0, 2),
  ...
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__pN, 3, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p1, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p1, 3, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p2, 5, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p2, 5, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_backtick, 3, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_backtick, 3, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p3, 7, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p3, 7, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p1, 4, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p1, 4, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p2, 6, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p2, 6, 0, 0),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__p3, 8, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__p3, 8, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_builtin_function_call, 2, 0, 2),
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_builtin_function_call, 2, 0, 2),
  ...
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 3, 0, 0),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 3, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 3, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 9, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 9, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 6, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 6, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 2, 0, 1),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mod, 2, 0, 1),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_setting, 2, 0, 3),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_setting, 2, 0, 3),
  [245] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [247] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 2, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import, 2, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_setting, 3, 0, 3),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_setting, 3, 0, 3),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__setting_boolean, 2, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__setting_boolean, 2, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 4),
  [265] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment, 3, 0, 4),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 4, 0, 5),
  [269] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 5),
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1, 0, 0),
  [273] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean, 1, 0, 0),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__setting_string, 2, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__setting_string, 2, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 1, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 1, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 3, 0, 1),
  [285] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mod, 3, 0, 1),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__setting_list, 6, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__setting_list, 6, 0, 0),
  ...
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_normal_string_repeat1, 2, 0, 0),
  [317] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_indented_normal_string_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [320] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_indented_normal_string_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  ...
  [333] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_normal_string_repeat1, 2, 0, 0), SHIFT_REPEAT(85),
  [336] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_normal_string_repeat1, 2, 0, 0), SHIFT_REPEAT(86),
  ...
  [349] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_normal_string_repeat1, 1, 0, 0),
  [351] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escape_sequence, 1, 0, 0),
  [353] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_normal_string_repeat1, 1, 0, 0),
  [355] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 1, 0, 0),
  [359] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  ...
  [368] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_raw_string_repeat1, 2, 0, 0),
  [370] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_indented_raw_string_repeat1, 2, 0, 0), SHIFT_REPEAT(109),
  ...
  [381] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_backtick_repeat1, 2, 0, 0),
  [383] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_indented_backtick_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  [386] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [388] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__setting_list_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__setting_list_repeat1, 2, 0, 0),
  ...
  [413] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 0),
  [415] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_raw_string_repeat1, 1, 0, 0),
  [417] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [419] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_indented_backtick_repeat1, 1, 0, 0),
